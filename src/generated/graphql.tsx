...
export type LaunchesQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type LaunchesQueryQuery = (
  { __typename?: 'Query' }
  & {
...
export type LaunchInfoQuery = (
  ...
  & {
    launch?: Maybe<(
      { __typename?: 'Launch' }
      & Pick<Launch, 'mission_id' | 'mission_name' | 'launch_year' | 'launch_success' | 'launch_date_local'>
      & {
        rocket?: Maybe<(
          { __typename?: 'LaunchRocket' }
...
export type RocketsQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type RocketsQueryQuery = (
  { __typename?: 'Query' }
  & {
    rockets?: Maybe<Array<Maybe<(
      { __typename?: 'Rocket' }
      & Pick<Rocket, 'rocket_name' | 'description' | 'first_flight' | 'cost_per_launch' | 'flickr_images'>
    )>>>
  }
);

export type PayloadQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type PayloadQueryQuery = (
  { __typename?: 'Query' }
  & {
    payload?: Maybe<(
      { __typename?: 'Payload' }
      & Pick<Payload, 'payload_id' | 'manufacturer' | 'nationality' | 'orbit'>
    )>
  }
);


export const LaunchesQueryDocument = gql`
    query LaunchesQuery {
  launches {
    flight_number
    mission_name
...
/**
 * __useLaunchesQueryQuery__
 *
 * To run a query within a React component, call `useLaunchesQueryQuery` and pass it any options that fit your needs.
 * When your component renders, `useLaunchesQueryQuery` returns an object from Apollo Client that contains loading, error, and data properties
 ...
 * });
 */
export function useLaunchesQueryQuery(baseOptions?: Apollo.QueryHookOptions<LaunchesQueryQuery, LaunchesQueryQueryVariables>) {
  return Apollo.useQuery<LaunchesQueryQuery, LaunchesQueryQueryVariables>(LaunchesQueryDocument, baseOptions);
}
export function useLaunchesQueryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LaunchesQueryQuery, LaunchesQueryQueryVariables>) {
  return Apollo.useLazyQuery<LaunchesQueryQuery, LaunchesQueryQueryVariables>(LaunchesQueryDocument, baseOptions);
}
export type LaunchesQueryQueryHookResult = ReturnType<typeof useLaunchesQueryQuery>;
export type LaunchesQueryLazyQueryHookResult = ReturnType<typeof useLaunchesQueryLazyQuery>;
export type LaunchesQueryQueryResult = Apollo.QueryResult<LaunchesQueryQuery, LaunchesQueryQueryVariables>;
...
export const RocketsQueryDocument = gql`
    query RocketsQuery {
  rockets {
    rocket_name
    description
...
/**
 * __useRocketsQueryQuery__
 *
 * To run a query within a React component, call `useRocketsQueryQuery` and pass it any options that fit your needs.
 * When your component renders, `useRocketsQueryQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useRocketsQueryQuery({
 *   variables: {
 *   },
 * });
 */
export function useRocketsQueryQuery(baseOptions?: Apollo.QueryHookOptions<RocketsQueryQuery, RocketsQueryQueryVariables>) {
  return Apollo.useQuery<RocketsQueryQuery, RocketsQueryQueryVariables>(RocketsQueryDocument, baseOptions);
}
export function useRocketsQueryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<RocketsQueryQuery, RocketsQueryQueryVariables>) {
  return Apollo.useLazyQuery<RocketsQueryQuery, RocketsQueryQueryVariables>(RocketsQueryDocument, baseOptions);
}
export type RocketsQueryQueryHookResult = ReturnType<typeof useRocketsQueryQuery>;
export type RocketsQueryLazyQueryHookResult = ReturnType<typeof useRocketsQueryLazyQuery>;
export type RocketsQueryQueryResult = Apollo.QueryResult<RocketsQueryQuery, RocketsQueryQueryVariables>;
export const PayloadQueryDocument = gql`
    query PayloadQuery {
...
/**
 * __usePayloadQueryQuery__
 *
 * To run a query within a React component, call `usePayloadQueryQuery` and pass it any options that fit your needs.
 * When your component renders, `usePayloadQueryQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = usePayloadQueryQuery({
 *   variables: {
 *   },
 * });
 */
export function usePayloadQueryQuery(baseOptions?: Apollo.QueryHookOptions<PayloadQueryQuery, PayloadQueryQueryVariables>) {
  return Apollo.useQuery<PayloadQueryQuery, PayloadQueryQueryVariables>(PayloadQueryDocument, baseOptions);
}
export function usePayloadQueryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<PayloadQueryQuery, PayloadQueryQueryVariables>) {
  return Apollo.useLazyQuery<PayloadQueryQuery, PayloadQueryQueryVariables>(PayloadQueryDocument, baseOptions);
}
export type PayloadQueryQueryHookResult = ReturnType<typeof usePayloadQueryQuery>;
export type PayloadQueryLazyQueryHookResult = ReturnType<typeof usePayloadQueryLazyQuery>;
export type PayloadQueryQueryResult = Apollo.QueryResult<PayloadQueryQuery, PayloadQueryQueryVariables>;